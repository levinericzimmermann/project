...
PART_TUPLE = (
    ...
    (((j("35/24"), j("35/32")), (j("105/64"), j("45/32"), j("35/32"))), (70, 50, 60)),
    # crossing -> park
    # we walk with prayer bowl f#-35ct (= 105/64) prayer bowl
    #   crossing:                   ?
    #   park:                       ?
    (
        ((j("105/64"), j("45/32"), j("35/32")), (j("105/64"), j("21/16"), j("63/64"))),
        (70, 50, 60),
    ),
    ...
    (((j("1/1"), j("3/2"), j("5/4")), (j("1/1"), j("3/2"))), (1 * 60, 1 * 60, 1 * 60)),
)
